""" On August 9, 2023, this is my first published App written in Rust with Python binding.
    ...
    For Linux platform, Copy the built .so file from release folder to same directory of the preview_file.py.
    For Windows platform, rename the built .dll from release folder and copy it to same directory of the preview_file.py.

    How to use the app:

    Python preview_file.py your_csv_file.csv
...
## 3 functions are reference to Rust
from preview_file import get_csv_info
from preview_file import view
from preview_file import write_csv_sample_file
